...
:: in (start, step(increment/decremet), stop) if u wanna shutdown ur system - up values to 1kk, do (start program) - every circle of the loop do run specified program
for /L %%i in (1,1,10) do (start cmd.exe)
